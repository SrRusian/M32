    ...
    <div className="workshop-card">
      <div className="workshop-card-image-container">
        ...
        <div className="workshop-card-badges">
          <div className="workshop-badges-left">
            {workshop.type && <span className="workshop-badge-type">{workshop.type}</span>}
            {workshop.category && <span className="workshop-badge-category">{workshop.category}</span>}
          </div>
          <div className="workshop-badges-right">
            <span className="workshop-badge-rating">
              ★ {workshop.rating}
            </span>
            <button className="workshop-favorite">
      ...
      <div className="workshop-card-content">
        ...
        <div className="workshop-card-footer">
          {workshop.date ? (
            <div className="workshop-date-info">
            ...
            <div className="workshop-info">
              {workshop.duration && (
                <span className="workshop-info-item">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
